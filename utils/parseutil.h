...
void readfile(const std::string& filename,std::vector<proc*>&pq,ProcessManager*manager=nullptr,proc* (ProcessManager::*condition)(const QString&name,const QString&time,const QString&pri)=nullptr);
